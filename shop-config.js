...
window.PARAMETRIC_SHOP = {
  ...
  projects: [{
    ...
    modelUrl: 'assets/models/boom.glb?v=f85eaf3fca',
    image: 'assets/boom/assembled-light.jpg',
    imageAlt: 'Studio render of the assembled Boom train: orange coach, cream roof, black roof vents and a smiling face.',
    available: false
  }, {
    id: 'station',
    title: 'Pebbl',
    ...
    description: [
      'A small aluminum companion for the clock, the weather and the next train. Pebbl brings useful information into the room, with a round AMOLED display, touch and voice.',
      'From the bedside to the kitchen: glance at your commute, start a timer, change a light or settle into a quiet night clock. Pebbl OS brings these everyday interactions together on the Waveshare ESP32-S3-Touch-AMOLED-1.75C.',
      'Explore the app states above. The interactive screen demos pair sample data with expressive lighting and motion, imagining what Pebbl can feel like in everyday use. The device is a visual reconstruction; small exterior details are illustrative, not manufacturing CAD.'
    ],
