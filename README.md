...
CSI Presence keeps its floor plan and building elevation together, with floor selection alongside them and the “A shared picture” component summary immediately below. Hardware versions, live readings, signal pipeline, system/recovery, accuracy research and evidence appear in keyboard-accessible tabs. Each tab retains its controls and state, including running comparisons and firmware walkthroughs.
