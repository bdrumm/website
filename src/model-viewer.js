...
export async function mountModelViewer(host,modelUrl,title="3D print",actionKind="",options={}){
 ...
 const canvas=document.createElement('canvas');canvas.setAttribute('aria-label',title+(isStation?' model. Tap screen controls, or Tab to use them with the keyboard. Drag or use arrow keys to tilt slightly. Scroll to move the page.':' model. Drag or use arrow keys to rotate. Scroll to move the page.'));canvas.tabIndex=0;
