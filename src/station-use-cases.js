...
export const STATION_USE_CASES=[
 {id:'coming-home',label:'01 / COMING HOME',title:'Back home. Settle in.',copy:'Put down your keys and bring the room to life. A light, a scene, a small request—Station keeps the everyday controls close.',alt:'Generated concept of a hand placing the small silver Station display on an entry table beside keys, showing the Living room light-control grid.'},
 {id:'docked',label:'02 / ON ITS DOCK',title:'A place on the desk.',copy:'A compact angled dock keeps the display in view. Glance at the time and weather while you work, read or pause for a moment.',alt:'Generated concept of the round silver Station display resting on a small angled desk dock, showing Station’s home screen with the time, weather and next train.'},
 {id:'city',label:'03 / OUT IN THE CITY',title:'Catch the next one.',copy:'Check the next train before heading underground. A pocket-sized display brings the commute into a single glance.',alt:'Generated concept of a hand holding the small round Station display showing Station’s F, G and A/C arrival cards on a New York sidewalk.'},
 ...
 {id:'waking-up',label:'05 / WAKING UP',title:'Meet the morning.',copy:'The hour and the weather, ready for the first glance. A quiet starting point before the day picks up.',alt:'Generated concept of the small silver Station display beside a bed in morning sunlight, showing Station’s home screen with the time, weather and next train.'}
];
