const layouts = [
  { id: 'garage', name: 'Single garage', number: '01', modules: '1 module', image: 'simplified-garage.jpg', thumbnail: 'simplified-garage.jpg', copy: 'A rolling door, a folding roof, and a fully equipped workshop.' },
  { id: 'row', name: 'Side by side', number: '02', modules: '3 modules', image: 'simplified-row.jpg', thumbnail: 'simplified-row.jpg', copy: 'Garage, kitchen, and dining arranged along one street.' },
  { id: 'stack', name: 'Stacked', number: '03', modules: '3 modules', image: 'simplified-stack.jpg', thumbnail: 'simplified-stack.jpg', copy: 'The same three modules arranged on a smaller footprint.' },
];
const presets = {
...
export function buildGarageProject(container, project) {
  ...
  experience.innerHTML = `
    ...
    <dl class="garage-facts"><div><dt>MODULE FOOTPRINT</dt><dd>200 × 240 <small>mm</small></dd></div><div><dt>STACK PITCH</dt><dd>128 <small>mm</small></dd></div><div><dt>ROLLING DOOR</dt><dd>12 <small>articulated slats</small></dd></div><div><dt>SOURCE</dt><dd>10 Sep 2026 <small>Blender snapshot</small></dd></div></dl>
    ...
    <section class="garage-about" aria-labelledby="garage-about-title"><div><span class="section-number">PRINT STUDY / 003</span><h2 id="garage-about-title">A garage with room to grow.</h2><div data-project-description></div></div><div class="garage-source-note"><h3>Latest model revision</h3><p>September 10 revision: continuous structural shells, tapered rear supports and an underfolding roof. Each structural shell is approximately 200 × 244.4 × 130 mm.</p><p>Stacking uses the source’s 128 mm pitch, with the two lower roofs detached. The scene preserves the source’s geometry and motion; physical fit still requires test prints.</p><a class="secondary-button" data-model-download>Download display model ↗</a><p class="muted">Display geometry in GLB format. Not a sliced print file.</p></div></section>
  `;
