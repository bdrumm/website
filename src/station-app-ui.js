...
export class StationAppUI{
 ...
 lightCard(pct,confirmed,clock,part){const color=AMBER;part(.1,()=>this.text('Living room',256,110,28,INK,'center',500));
 ...
 scene(id,t,clock,part){const done=id==='done',running=id==='running';part(.1,()=>{this.glow(256,155,135,LILAC,.21);this.glow(279,158,63,AMBER,.12);this.icon('moon',256,155,52,AMBER);this.text('Good night',256,225,40,INK,'center',300);this.text(done?'Everything is taken care of.':running?'A softer landing for the day.':'Let the day wind down.',256,267,16,MUTED);});
