# Q43 — Batteryless switch, measured 4.3-inch board

**Measurement prototype — physical fit is not yet approved.**

Case, portrait: **71.6 × 132.3 × 18.4 mm**. Main rim: **17.2 mm**. Mount face to front rim: **27.7 mm**. Existing wall-cover projection is additional. Print the one-piece case and holder as a matched set; P43/Q43 holders are not interchangeable.
...
This revision is for the PCB labeled **ESP32-P4-WIFI6-Touch-LCD-4.3**. The owner measured the glass at **114 × 65 mm** and front glass to screw end at **11.5 mm**, and confirmed a **92 × 50 mm** screw pattern. Speaker housing: **26 × 26 × 5 mm**, lead **50 mm**. No battery is installed in Q43.
...
3. Leave BAT and CAMERA unused. Keep the rear cable bay open; no battery is installed in Q43.
