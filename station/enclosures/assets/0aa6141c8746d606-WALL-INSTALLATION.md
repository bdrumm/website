# Wall setup W3 - common F case, assembly and installation

The wall assembly has **exactly two printed pieces**: the same common F device
...
Use the matching **F cup and W3 holder**. Earlier external-ear cups and holders
...
| Item | Specification |
|---|---|
| Print 1 | `exports/devicecase.stl`: shared F cup with recessed receivers and speaker catches |
...
F case. Rigid-solid checks do not prove that a loose lead or a thicker real
...
- The holder clears the speaker leaf access zone. The cup and modeled
  ...
  model. Speaker-to-board separation is 7.73 mm in the shared F case.
