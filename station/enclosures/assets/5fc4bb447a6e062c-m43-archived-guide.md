# M43 — Battery wall, measured 4.3-inch board

**Measurement prototype — physical fit is not yet approved.**

Case, portrait: **69.3 × 118.3 × 23.7 mm**. Main rim: **16.4 mm**. Mount face to front rim: **28 mm**. Existing wall-cover projection is additional. Print the case and holder as a matched pair; M43/L43 holders are not interchangeable.

The **65 × 36 × 10 mm** cased battery lies lengthwise along the display's 114 mm dimension, beside the **26 × 26 × 5 mm** speaker. The dimensions include the battery casing. The speaker retains its full-size housing, long clip leaves and 50 mm lead. This M43 layout supersedes the archived K43 layout for the earlier 52 mm battery.
