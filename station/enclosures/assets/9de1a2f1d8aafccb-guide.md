...
**Revision D: one shared device cup, 23.7 mm deep.** Its shell body is
131.2 × 75.0 mm; integral docking ears extend the footprint to 132.15 × 77.6 mm.
The same printed cup works handheld or in holder W2. Portable assembly adds
...
still need measurement. The marked small side opening and its opposite-side
counterpart are closed. Computer clearance does not establish physical fit.
...
|---|---|
| Printed assembly | Shared device cup D (one printed assembly part) |
...
3. **Battery:** inspect the casing; use removable adhesive in the smooth
   ...
   the pack against the rear wall. Revision D budgets **0.25 mm rear adhesive**
...
It uses the exact same device cup D plus holder W2, with both USB sockets down.
