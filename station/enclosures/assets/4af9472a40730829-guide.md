...
**Revision E: one shared device cup, 131.2 × 75.0 × 23.7 mm.**
...
|---|---|
| Printed assembly | Shared device cup E (one printed assembly part) |
...
3. **Battery:** inspect the casing; use removable adhesive in the smooth
   ...
   the pack against the rear wall. Revision E budgets **0.25 mm rear adhesive**
...
It uses the exact same device cup E plus holder W3, with both USB sockets down.
