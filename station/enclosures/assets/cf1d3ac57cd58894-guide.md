...
**Revision C: measurement prototype, 131.2 × 75 × 23.7 mm.** Portable depth stays 23.7 mm; the battery sets the limiting stack. The separate
wall version removes battery and camera and uses a 20.4 mm cup. Speaker, camera and cable details still need
...
|---|---|
| Printed assembly | Current portable cup (one printed assembly part) |
...
4. Test the speaker clip coupon with the actual rigid housing. Slip its left
   ...
   Move the housing through all available lateral play: both right catches
...
exported orientation so clip beams rise from the rear wall. These settings require validation on your printer.
...
2. **Speaker:** verify its actual sound outlet faces the rear grille. Fit a
   ...
   on squeezing the housing. Light tack at the perimeter gasket maintains
...
3. **Battery:** inspect the casing; use removable adhesive in the smooth
   ...
   the pack against the rear wall. Revision C budgets **0.25 mm rear adhesive**
...
It is a separate cup plus a snap holder, installed with both USB sockets down.
Do not put the portable cup into that holder: its depth and docking features differ.
