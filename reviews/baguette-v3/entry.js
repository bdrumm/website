...
try {const response=await fetch('./baguette-v3.glb?v=3.14-roof');if(!response.ok)throw new Error('Model unavailable');await mountReview(root,await response.arrayBuffer());}
