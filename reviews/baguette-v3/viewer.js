...
export async function mountReview(root, buffer) {
 ...
 const presets={overall:{target:[0,0,-20],position:[120,180,680],width:350},hinge:{target:[150,0,-41],position:[190,150,10],width:32},section:{target:[150,0,-41],position:[50,2,-44],width:15},latch:{target:[150,0,43],position:[170,30,225],width:35},catch:{target:[150,-4,42],position:[245,5,45],width:18},jointsection:{target:[-4,36,0],position:[-4,36,100],width:22},joint:{target:[-4,10,0],position:[-85,150,220],width:85}};
