...
export async function mountReview(root, buffer, {configureControls,initialColor,configureMaterial,lighting={}} = {}) {
 ...
 const presets={strap:{target:[271.5,-3.5,50],position:[320,-50,160],width:40},overall:{target:[0,0,-20],position:[120,180,680],width:350},hinge:{target:[150,0,-41],position:[190,150,10],width:32},section:{target:[150,0,-41],position:[50,2,-44],width:15},latch:{target:[134,-3,43],position:[154,-135,200],width:40},catch:{target:[150,-4,42],position:[245,5,45],width:18},jointsection:{target:[1.5,39.8,0],position:[1.5,39.8,100],width:22},joint:{target:[-4,10,0],position:[-85,150,220],width:85}};
